...
import { IGetAllListVideo } from '@/modules/learners/types';

type IGetAllListVideoProps = {
  data: IGetAllListVideo;
};
//
const CardListVideoTrendingLatest = ({ data }: IGetAllListVideoProps) => {
  return (
    <div
...
export default CardListVideoTrendingLatest;
