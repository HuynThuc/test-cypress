  ...
  document.addEventListener('webkitfullscreenchange', function (t) {
    ...
    r === e
      ? e.style.width &&
        ...
        (e.style.width = '100%'),
        (e.style.height = '100%'))
      : p && ((e.style.width = p), (e.style.height = g), (p = ''), (g = ''));
  });
  var m = {
    Module: c,
            ...
            function r() {
              return 'undefined' == typeof a
                ...
                : a.read().then(function (e) {
                    return e.done
                      ? o()
                      : (l + e.value.length <= d.length
                          ? (d.set(e.value, l), (c = l + e.value.length))
                          : u.push(e.value),
                        (l += e.value.length),
                        n({
                          type: 'progress',
    ...
    (c.UnityCache = (function () {
      function e() {
        function e(e) {
          ...
          if (
            (t.objectStoreNames.contains(n.name) || t.createObjectStore(n.name),
        ...
        a.isConnected = new Promise(function (r, n) {
          function s() {
            a.openDBTimeout &&
              (clearTimeout(a.openDBTimeout), (a.openDBTimeout = null));
          }
          try {
            a.openDBTimeout = setTimeout(function () {
              'undefined' == typeof a.database &&
                n(new Error('Could not connect to database: Timeout.'));
            }, 2e3);
      ...
      function o(e, t, r, n, o) {
        ...
        return (
          o &&
            ...
            ['redirected', 'status', 'statusText', 'type', 'url'].forEach(
              function (e) {
                a.response[e] = o[e];
              },
            ),
          ...
          g.enabled
            ? h
                ...
                .then(function (t) {
                  ...
                  if (
                    r(g.result.url) &&
                    (o.headers.get('Last-Modified') || o.headers.get('ETag'))
                  )
                    return fetch(g.result.url, { method: 'HEAD' }).then(
                      function (t) {
                        return (
                          (g.revalidated = ['Last-Modified', 'ETag'].every(
                            function (e) {
                              return (
                                !o.headers.get(e) ||
                                o.headers.get(e) == t.headers.get(e)
                              );
                            },
                          )),
                          g.revalidated
                  ...
                  return (
                    ...
                    o.headers.get('Last-Modified')
                      ...
                      : o.headers.get('ETag') &&
                        ((a['If-None-Match'] = o.headers.get('ETag')),
                        (a['Cache-Control'] = 'no-cache')),
                    c(s, l)
                  );
                })
